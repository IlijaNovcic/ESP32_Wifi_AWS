...
#define OTA_UPDATE_PENDING 0u
#define OTA_UPDATE_SUCCESSFUL 1u
...
typedef enum http_server_message
{
	...
	HTTP_MSG_WIFI_CONNECT_SUCCES,
	HTTP_MSG_WIFI_CONNECT_FAIL,
	HTTP_MSG_WIFI_USER_DISCONNECT,
	HTTP_MSG_WIFI_CONNECT_OTA_UPDATE_SUCCESSUL,
	HTTP_MSG_WIFI_CONNECT_OTA_UPDATE_FAIL,
