...
#define WIFI_AP_CHANNEL						1u								// AP channel
#define WIFI_AP_SSID_HIDDEN				0u								// AP visibility
#define WIFI_AP_MAX_CONNECTIONS		5u								// AP max clients
#define WIFI_AP_BEACON_INTERVAL		100u							// AP beacon: 100 milliseconds recommended
#define WIFI_AP_IP								"192.168.0.3"			// AP default IP
#define WIFI_AP_GATEWAY						"192.168.0.3"			// AP default Gateway (should be the same as the IP)
#define WIFI_AP_NETMASK						"255.255.255.0"		// AP netmask
#define WIFI_AP_BANDWIDTH					WIFI_BW_HT20			// AP bandwidth 20 MHz (40 MHz is the other option)
#define WIFI_STA_POWER_SAVE				WIFI_PS_NONE			// Power save not used
#define MAX_SSID_LENGTH						32u								// IEEE standard maximum
#define MAX_PASSWORD_LENGTH				64u								// IEEE standard maximum
#define MAX_CONNECTION_RETRIES		5u								// Retry number on disconnect
...
{
	WIFI_APP_MSG_START_HTTP_SERVER = 0u,
